...
//   --with-held  include sources in HELD_SOURCES (license riders awaiting review)
...
// Sources whose license carries a rider needing explicit review before we publish them
...
//
// clickbench cleared this list 2026-07-05: smplmark.org is permanently non-commercial, which
// satisfies CC-BY-NC-SA-4.0's NonCommercial clause outright.
const HELD_SOURCES = [];
