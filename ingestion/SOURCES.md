...
| Pull | `data.generated.js` (the dashboard's own aggregated dataset: latest result per system+machine, 778 entries, 0.95 MB), pinned to the current main commit SHA; plus the LICENSE file for the archive. |
