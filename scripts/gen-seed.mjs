...
INSERT INTO account (id, key, name, description, created_at, allow_personal_publish) VALUES
  (${q(acctId)}, 'smplkit', 'smplkit', 'smplkit builds developer infrastructure — configuration, feature flags, logging, and audit as independently deployable services.', ${T0}, 1);
