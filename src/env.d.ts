...
interface SmplmarkSecrets {
  ...
  /** Credential-keyed rate limiter for measurement ingest (120 / 60s per API key / account). */
  RL_INGEST?: RateLimiter;
  /** Credential-keyed rate limiter for other resource-creating writes (30 / 60s per credential). */
