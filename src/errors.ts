...
// Client input never 500s; malformed input is 400 (not 422); every error carries a
...
/**
 * A credential failure. Descriptive but non-leaky: the "invalid, expired, or revoked"
...
/**
 * Not found. The default detail is a static, generic string so cross-tenant
